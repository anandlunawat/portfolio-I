...
export default function Profile() {
    ...
    return (
        <div className={`${raleway.className}fixed z-50 max-lg:fixed flex flex-col right-2 bottom-[18%] lg:h-fit lg:w-[25%] 2xl:w-[30%]`}>
            {
            ...
            <button onClick={() => { setFloatingButton(!floatingButton) }} className="rounded-full lg:hidden fixed z-50 right-2 bottom-[10%] w-fit mt-auto  p-2 border-2">
                <AiOutlinePlus />
            </button>
            ...
            <div className="flex flex-col items-center justify-center rounded-lg max-lg:hidden bg-opacity-40 gap-2 overflow-hidden h-full p-4">
                ...
                <div className="flex flex-row gap-2 ml-4 2xl:gap-4">
                    <Link href="https://www.linkedin.com/in/anand-lunawat-aa220622b/" className="2xl:text-2xl rounded-lg p-3">
                        <FaLinkedinIn style={{ color: "#0072b1" }} />
                    </Link>
                    <Link href="https://github.com/anandlunawat" className="2xl:text-2xl rounded-lg p-3">
                        <FaGithub />
                    </Link>
                    <Link href={"https://www.instagram.com/anand__lunawat/?hl=en"} className="2xl:text-2xl rounded-lg p-3">
                        <FaInstagram style={{ color: "#fa7e1e" }} />
                    </Link>
                </div>
                <div className="flex flex-col p-2  2xl:m-2 w-full rounded-lg">
